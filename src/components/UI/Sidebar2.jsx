  ...
  return (
    <>
      ...
      <button
        ...
        type="button"
        className="block sm:flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 h-16 max-h-16"
      >
        ...
        <div className="h-full px-3 py-4 overflow-y-auto">
          ...
          <nav className="space-y-2 font-medium">
            ...
            >
              {" "}
              <svg
                className="shrink-0 w-4 h-4 text-gray-500 transition duration-75 dark:text-gray-400"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 18 18"
